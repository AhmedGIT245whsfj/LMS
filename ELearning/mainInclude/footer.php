 ...
 <footer class="container-fluid bg-dark text-center p-2">
    <small class="text-white">Copyright &copy; 2019 || Designed By ITVERSE || <?php   
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <?php if (file_exists(__DIR__ . "/studentRegistration.php")) { if (basename($_SERVER["PHP_SELF"]) == "index.php") {
include(__DIR__ . "/studentRegistration.php"); }} ?>
            ...
            <form role="form" id="stuLoginForm">
              <div class="form-group">
                <i class="fas fa-envelope"></i><label for="stuLogEmail" class="pl-2 font-weight-bold">Email</label><small id="statusLogMsg1"></small><input type="email"
                    class="form-control" placeholder="Email" name="stuLogEmail" id="stuLogEmail" name="noauto_stu_email" autocomplete="off" autocapitalize="none" spellcheck="false">
                </div>
                <div class="form-group">
                  <i class="fas fa-key"></i><label for="stuLogPass" class="pl-2 font-weight-bold">Password</label><input type="password" class="form-control" placeholder="Password" name="stuLogPass" id="stuLogPass" name="noauto_stu_pass" autocomplete="new-password">
              </div>
            </form>
          </div>
          <div class="modal-footer">
