      ...
      <div class="collapse navbar-collapse" id="myMenu">
        <ul class="navbar-nav pl-5 custom-nav">
          ...
          <?php if (isset($_SESSION['is_login'])): ?>
            <li class="nav-item custom-nav-item"><a href="/Student/myprofile.php" class="nav-link">My Profile</a></li>
            <li class="nav-item custom-nav-item"><a href="/Student/studentLogout.php" class="nav-link">Logout</a></li>
          <?php else: ?>
            ...
            <li class="nav-item custom-nav-item"><a href="loginorsignup.php" class="nav-link">Signup</a></li>
          <?php endif; ?>
