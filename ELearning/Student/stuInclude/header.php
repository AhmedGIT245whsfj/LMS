...
<style>
/* ITVERSE fixed top bar (robust; works even if sticky breaks due to overflow parents) */
.itv-topbar{
...
.itv-brand{color:#fff;text-decoration:none;display:inline-block}
.itv-brand:hover{color:#fff;text-decoration:underline}
...
<body>
<div class="itv-topbar"><a class="itv-brand" href="../index.php">ITVERSE</a></div>
